...
# proto_to_keep = [0,1,2,3,5,6,9,10,11,12,13] #for model /usr/xtmp/mammo/alina_saved_models/vgg16/0129_pushonall_topkk=9_fa=0.001_random=4/50_4push0.9546.pth
# proto_to_keep = [0,1,9,10,12] #for model /usr/xtmp/mammo/alina_saved_models/vgg16/0125_topkk=9_fa=0.001_random=12/100_3push0.9496.pth
# proto_to_keep = [0,1,7,9,10,11,14] #for model /usr/xtmp/mammo/alina_saved_models/vgg16/0125_topkk=9_fa=0.001_random=7/100_9push0.9514.pth
proto_to_keep = [0,1,5,9,10,11] #for model /usr/xtmp/mammo/alina_saved_models/vgg16/0125_topkk=9_fa=0.001_random=4/50_9push0.9645.pth
# proto_to_keep = [0,1,5,8,9,10,11,12] #for model /usr/xtmp/mammo/alina_saved_models/vgg16/finer_annotations_rerun/
# proto_to_keep = [0,1,2,5,6,8,9,10,11] #for model 1202_top05_fa1e-3_withfinerfa
# pruning parameters
k = 5
prune_threshold = 3

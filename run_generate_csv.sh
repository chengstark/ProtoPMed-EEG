...
sample_root_dir="/usr/xtmp/zg78/proto_proj/data/external_test/"
data_dir="${sample_root_dir}test/"
csv_name="base_multi_class_prototype_3topoverall[external_test]"

# model_path="/usr/xtmp/zg78/proto_proj/saved_models/eeg_model/10-05-2022_11-31_code_cleanup_check_1664983881/10push0.1760.pth"
# sample_root_dir="/usr/xtmp/zg78/proto_proj/data/10_train_test_split_50s_/"
# data_dir="${sample_root_dir}test/"
# csv_name="code_cleanup_check"

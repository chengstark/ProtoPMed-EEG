...
# model_cnn = torch.load("model_1130.pt", map_location=torch.device('cpu'))
...
# total_file_list = os.listdir("./data/")
...
#         print(X.shape, 'X SHAPE BEFORE MODEL FORWARD')
...
#     path3 = "./results/"+ save_name + "_score.csv"
    
#     np.savetxt(path3, unlabeled_score, delimiter=',')
    
    
#     path4 = "./results/"+ save_name + "_vector.csv"
